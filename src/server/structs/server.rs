use smol::{io::{AsyncReadExt, Error, ErrorKind}, io::AsyncWriteExt, net::TcpStream, spawn, Timer};
...
use super::{Parser, GitRunner};


pub async fn parse_http(stream: &mut TcpStream) -> std::io::Result<Request<()>>{
...
pub async fn handle_connection(mut stream: TcpStream, addr: std::net::SocketAddr) -> std::io::Result<()>{
